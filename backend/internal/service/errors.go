...
var (
	...
	ErrLinkedSpecimen    = errors.New("linked specimen is required before signoff review")
	ErrDistinctReviewer  = errors.New("first and second reviewers must be different users")
)
