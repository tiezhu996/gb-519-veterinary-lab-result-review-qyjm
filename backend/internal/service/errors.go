...
var (
	...
	ErrRelatedSpecimenMissing = errors.New("related specimen is missing and cannot be risk graded")
	ErrDuplicateReviewer      = errors.New("the second reviewer must differ from the first reviewer")
)
