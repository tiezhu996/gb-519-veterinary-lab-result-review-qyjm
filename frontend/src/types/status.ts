...
export type SignoffState = 'draft' | 'peer_review' | 'secondary_review' | 'signed' | 'rejected';
export const ALL_SIGNOFF_STATE: readonly SignoffState[] = ['draft', 'peer_review', 'secondary_review', 'signed', 'rejected'];
...
export const ENTITY_CONFIGS: readonly EntityConfig[] = [
  ...
  { key: 'resultSignoff', path: 'signoff', label: '结果签发', statuses: ['draft', 'peer_review', 'secondary_review', 'signed', 'rejected'] as const, primaryTransitions: { draft: 'peer_review', peer_review: 'signed', secondary_review: 'signed' } }
];
